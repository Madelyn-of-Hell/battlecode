...
//		assertEquals(0b1001010011, Communication.mask(unmasked_value, 10));
//		assertEquals(0b1111001010011, Communication.mask(unmasked_value, 13));
//	}
//
//	@Test
...
//		final int correct_answer = message_type << 27 | new_protocol.value << 25 | Communication.mask(demo_rat_id, 25);
//
...
//	final int message_type = NewRatProtocol.message_id;
//	final RobotProtocol new_protocol = RobotProtocol.Gather;
//	final int packaged_message = message_type << 27 | new_protocol.value << 25 | Communication.mask(demo_rat_id, 25);
...
//		final int correct_answer = message_type << 27 | received_message_type << 22 | Communication.mask(demo_rat_id, 22);
//
...
//		final int correct_answer = message_type << 27 | Communication.mask(waypoint_position.x, 6) << 21 | Communication.mask(waypoint_position.y, 6) << 15;
...
//		final int message_type = CatWaypointFound.message_id;
//		final MapLocation waypoint_position = new MapLocation(40,22);
//		final int packaged_message = message_type << 27 | Communication.mask(waypoint_position.x, 6) << 21 | Communication.mask(waypoint_position.y, 6) << 15;
//		final int encrypted_message = packaged_message ^ shared_mask;
//
//		final Message message = new Message(encrypted_message, 1, 1, new MapLocation(1,1));
...
//		final int correct_answer = message_type << 27 | Communication.mask(mine_position.x, 6) << 21 | Communication.mask(mine_position.y, 6) << 15;
...
//		final int message_type = CheeseMineFound.message_id;
//		final MapLocation mine_position = new MapLocation(40,22);
//		final int packaged_message = message_type << 27 | Communication.mask(mine_position.x, 6) << 21 | Communication.mask(mine_position.y, 6) << 15;
//		final int encrypted_message = packaged_message ^ shared_mask;
//		final Message message = new Message(encrypted_message, 1, 1, new MapLocation(1,1));
...
//		final int correct_answer = message_type << 27 | Communication.mask(king_position.x, 6) << 21 | Communication.mask(king_position.y, 6) << 15 | Communication.mask(demo_rat_id, 15);
//		final CatWaypointFound message = new CatWaypointFound();
...
//
//		final int packaged_message = message_type << 27 | Communication.mask(king_position.x, 6) << 21 | Communication.mask(king_position.y, 6) << 15 | Communication.mask(king_id, 15);
//		final int encrypted_message = packaged_message ^ shared_mask;
//		final Message message = new Message(encrypted_message, 1, 1, new MapLocation(1,1));
//
...
//		final int correct_answer = message_type << 27 | Communication.mask(pack_size, 13) << 14 | Communication.mask(demo_rat_id, 13) << 1;
...
//
//		final int packaged_message = message_type << 27 | Communication.mask(pack_size, 8) << 19 | Communication.mask(pack_id, 19);
//		final int encrypted_message = packaged_message ^ shared_mask;
//		final Message message = new Message(encrypted_message, 1, 1, new MapLocation(1,1));
//
...
//		final int correct_answer = message_type << 27 | Communication.mask(old_pack_id, 13) << 14 | Communication.mask(demo_rat_id, 13) << 1;
//		final WaowieYourRatPackIsSoBigIWannaComeWithYouToAttack message = new WaowieYourRatPackIsSoBigIWannaComeWithYouToAttack(decrypted_message);
...
//
//		final int packaged_message = message_type << 27 | Communication.mask(old_pack_id, 13) << 14 | Communication.mask(new_pack_id, 13) << 1;
//		final int encrypted_message = packaged_message ^ shared_mask;
//		final Message message = new Message(encrypted_message, 1, 1, new MapLocation(1,1));
//
//		final WaowieYourRatPackIsSoBigIWannaComeWithYouToAttack correct_answer = new WaowieYourRatPackIsSoBigIWannaComeWithYouToAttack(decrypted_message);
...
//		WaowieYourRatPackIsSoBigIWannaComeWithYouToAttack message = new WaowieYourRatPackIsSoBigIWannaComeWithYouToAttack(decrypted_message) ;
...
//		final MapLocation victim_pos = new MapLocation(40,22);
//		final int correct_answer = message_type << 27 | Communication.mask(victim_pos.x, 6) << 21 | Communication.mask(victim_pos.y, 6) << 15 | Communication.mask(demo_rat_id, 15);
//		final RatPackShouldAttack message = new RatPackShouldAttack();
//		message.victim_pos = victim_pos;
//		assertEquals(correct_answer, message.package_message());
//	}
//
//	@Test
//	public void TestParseRatPackShouldAttack() {
//		final int message_type = RatPackShouldAttack.message_id;
//
//		final MapLocation victim_pos = new MapLocation(40,22);
//		final int pack_id = 123456789;
//
//		final int packaged_message = message_type << 27 | Communication.mask(victim_pos.x, 6) << 21 | Communication.mask(victim_pos.y, 6) << 15 | Communication.mask(pack_id, 15);
//		final int encrypted_message = packaged_message ^ shared_mask;
//		final Message message = new Message(encrypted_message, 1, 1, new MapLocation(1,1));
//
//		final RatPackShouldAttack correct_answer = new RatPackShouldAttack();
//		correct_answer.victim_pos = victim_pos;
//		correct_answer.pack_id = pack_id;
//
//		Communication output = Communication.parse(message, key);
//		assertEquals(correct_answer, output);
...
//
//	@Test
//	public void TestHandleRatPackShouldAttackIgnore() {
//		RatPackShouldAttack message = new RatPackShouldAttack() ;
//		message.victim_pos = new MapLocation(40,22);
//		message.pack_id = 123456789;
//		RobotPlayer[] self = new RobotPlayer[]{new RobotPlayer(
//				100,
//				RobotProtocol.Attack,
//				false,
...
//		final int correct_answer = message_type << 27 | Communication.mask(demo_rat_id, 27);
...
//
//		final int packaged_message = message_type << 27 | Communication.mask(param_one, BIT_ALLOTMENT_ONE) << BITSHIFT_ONE | Communication.mask(param_two., BIT_ALLOTMENT_TWO) << BITSHIFT_TWO;
//		final int encrypted_message = packaged_message ^ shared_mask;
//		final Message message = new Message(encrypted_message, 1, 1, new MapLocation(1,1));
//
